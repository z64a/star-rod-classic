...
public class CreateOptionsPanel extends JPanel
{
	...
	public CreateOptionsPanel()
	{
		...
		((DefaultEditor) widthSpinner.getEditor()).getTextField().setHorizontalAlignment(JTextField.CENTER);
		((DefaultEditor) heightSpinner.getEditor()).getTextField().setHorizontalAlignment(JTextField.CENTER);

...
public class ItemEntityListRenderer extends JPanel implements ListCellRenderer<ItemEntityRecord>
{
	private final GlobalsData globals;
	private final JLabel iconLabel;
	private final JLabel nameLabel;

	public ItemEntityListRenderer(GlobalsData globals)
	{
	...
	public Component getListCellRendererComponent(
		JList<? extends ItemEntityRecord> list,
		ItemEntityRecord obj,
		int index,
		boolean isSelected,

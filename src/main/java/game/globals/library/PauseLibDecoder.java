...
public class PauseLibDecoder extends BaseDataDecoder
{
	...
	public PauseLibDecoder(ByteBuffer fileBuffer, int startOffset, int endOffset, int baseAddress, String libName) throws IOException
	{
		this(fileBuffer, startOffset, endOffset, baseAddress, libName, null);
	}

	public PauseLibDecoder(ByteBuffer fileBuffer, int startOffset, int endOffset, int baseAddress, String libName, String hintName) throws IOException
	{
		//TODO no valid ancestor type...
		super(LibScope.Pause, ScriptT, ProjectDatabase.rom.getLibrary(LibScope.Pause));
		...
		File scriptFile = new File(DUMP_LIB + libName + ".pscr");
		File indexFile = new File(DUMP_LIB + libName + ".pidx");

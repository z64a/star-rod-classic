...
import static game.string.StringConstants.CharacterEncoding.*;
...
{
	public static final int NUM_STRING_SECTIONS = 0x2F;

	public static final String[] STRING_SECTION_NAMES = {
			"00 Introduction",

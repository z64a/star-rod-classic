...
import static game.string.StringConstants.ControlCharacter.STYLE;
...
public class StringDecoder
{
	...
	private static final Pattern CancelPattern = Pattern.compile("\\[SetCancel (\\d+)\\]");
	private static final Matcher CancelMatcher = CancelPattern.matcher("");
	...
	public static String toMarkup(byte[] message)
	{
		...
		text = text.replaceAll("(?i)\\[SaveColor\\]\\[Color 0x15\\]\\[~(L|R)\\]\\[RestoreColor\\]", "[$1]");

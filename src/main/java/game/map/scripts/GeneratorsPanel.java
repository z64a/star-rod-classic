...
public class GeneratorsPanel extends JPanel implements IShutdownListener
{
	...
	{
		generatorsTree = new SimpleEditableJTree(new CategoryTreeModel<>("Default"));
		...
		generatorsTree.getSelectionModel().addTreeSelectionListener(e -> {
			CategoryTreeNode<GeneratorType, Generator> node = (CategoryTreeNode<GeneratorType, Generator>) generatorsTree.getLastSelectedPathComponent();

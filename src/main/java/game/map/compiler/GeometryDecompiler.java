...
public class GeometryDecompiler
{
	...
	{
		try {
			pwDL = new PrintWriter(Directories.DUMP_REPORTS + "DL.txt");
			pwPL = new PrintWriter(Directories.DUMP_REPORTS + "PL.txt");
	...
	// furthermore, evidence for the vetex buffer size being 32 on N64 hardware
	// http://forums.maco64.com/search/?c=3&mid=268014&month=3&year=2013

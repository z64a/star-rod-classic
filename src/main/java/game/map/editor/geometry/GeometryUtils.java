...
public class GeometryUtils
{
	...
	private static TriangleBatch batchFromXZ(TriangleBatch batch, Axis axis)
	{
		...
		if (axis != Axis.Y) {
			...
			rotated.triangles.addAll(batch.triangles);
		}
	...
	{
		Vector3f norm1 = Vector3f.sub(p2, p1).normalize();
		Vector3f norm2 = Vector3f.sub(p4, p3).normalize();
	...
	public static Vector3f getVectorBetween(Vector3f a, Vector3f b)
	{
		return Vector3f.sub(b, a);
	}

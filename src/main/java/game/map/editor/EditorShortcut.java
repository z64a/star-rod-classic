...
import game.sprite.editor.SpriteShortcutsPanel;
 ...
 * <br>
 * When adding a new shortcut, be sure to add a corresponding entry to {@link SpriteShortcutsPanel},
	...
	private KeyStroke getKeyStoke()
	{
		...
		switch (keyMod) {
			case NONE:
				...
				break;
			case CTRL:
				awtMask = KeyEvent.CTRL_DOWN_MASK;
				break;
			case SHFT:
				awtMask = KeyEvent.SHIFT_DOWN_MASK;
				break;
		}

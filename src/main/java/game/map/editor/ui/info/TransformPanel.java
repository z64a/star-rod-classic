...
public class TransformPanel extends JPanel
{
	...
	public TransformPanel()
	{
		...
		((DefaultEditor) rotX.getEditor()).getTextField().setHorizontalAlignment(JTextField.CENTER);
		...
		((DefaultEditor) rotY.getEditor()).getTextField().setHorizontalAlignment(JTextField.CENTER);
		...
		((DefaultEditor) rotZ.getEditor()).getTextField().setHorizontalAlignment(JTextField.CENTER);

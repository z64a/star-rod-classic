...
public enum MapKey implements XmlKey
{
	...
	TAG_BOMB_POS		("BombTrigger"),
	ATTR_MARKER_RADIUS		("radius"),

	TAG_CAM_TARGET		("CamTarget"),
	ATTR_CAM_USE_SAMPLE		("sampleZone"),
	ATTR_CAM_SAMPLE_POS		("samplePos"),
	...
	TEMP_ATTR_SCROLL	("previewScroll"), //XXX
	...
	// old fields
	ATTR_PAN_MAIN_INIT	("mainInit"),
	ATTR_PAN_AUX_INIT	("auxInit"),
	ATTR_PAN_MAIN_STEP	("mainStep"),
	ATTR_PAN_AUX_STEP	("auxStep"),
	ATTR_PAN_MAIN_TICK	("mainFreq"),
	ATTR_PAN_AUX_TICK	("auxFreq"),
	...
	TAG_ENTITY				("Entity"),
	ATTR_NTT_HAS_FLAG		("hasFlag"),
	ATTR_NTT_FLAG			("flag"),
	ATTR_NTT_HAS_SPAWN_FLAG ("hasSpawnFlag"),
	ATTR_NTT_SPAWN_FLAG		("spawnFlag"),
	ATTR_NTT_CALLBACK		("callback"),
	ATTR_NTT_ITEM			("item"),
	ATTR_NTT_HAS_ITEM		("hasItem"),
	ATTR_NTT_ITEM_SPAWN		("itemSpawnMode"),
	ATTR_NTT_DEST_MARKER	("destMarker"),
	ATTR_NTT_MODEL			("model"),
	ATTR_NTT_COLLIDER		("collider"),
	ATTR_NTT_HAS_AREA_FLAG	("hasAreaFlag"),
	ATTR_NTT_AREA_FLAG		("areaFlag"),
	ATTR_NTT_MAP_VAR		("mapVar"),
	ATTR_NTT_AUTO_AREA_FLAG	("autoAreaFlag"),
	ATTR_NTT_AUTO_MAP_VAR	("autoMapVar"),
	ATTR_NTT_LAUNCH_H		("launchH"),
	ATTR_NTT_LAUNCH_T		("launchT"),
	ATTR_NTT_ANGLE			("angle"),
	ATTR_NTT_PATH			("pathMarker"),
	ATTR_NTT_DEST_MAP		("destMap"),
	ATTR_NTT_DEST_ENTRY		("destEntry"),
	ATTR_NTT_USE_DEST_ID	("destUseID"),

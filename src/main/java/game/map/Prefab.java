...
public class Prefab
{
	...
	public Prefab(String texName, String author)
	{
	...
	public Prefab(Iterable<MapObject> objects, ListModel<LightSet> lightSetList, String texName, String author)
	{
		this(texName, author);
	...
	public void fromXML(XmlReader xmr)
	{
		...
		if (xmr.hasAttribute(prefabElem, ATTR_AUTHOR))
			author = xmr.getAttribute(prefabElem, ATTR_AUTHOR);

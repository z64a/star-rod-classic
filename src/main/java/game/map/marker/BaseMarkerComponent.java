...
public abstract class BaseMarkerComponent
{
	...
	public abstract void toBinary(ObjectOutput out) throws IOException;

	public abstract void fromBinary(ObjectInput in) throws IOException, ClassNotFoundException;

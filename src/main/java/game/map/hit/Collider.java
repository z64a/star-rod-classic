...
public class Collider extends HitObject implements XmlSerializable
{
	...
	// though these CAN be hardcoded, they are typically set during the map's MainScript

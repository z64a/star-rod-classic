...
public class SpriteShadingData
{
	...
	public static final int CUSTOM_GROUP_ID = SpriteShadingEditor.NUM_GROUPS;
	...
	public void createModel(ArrayList<ArrayList<ShadingProfile>> groups)
	{
		listModel.clear();

		listModel.addElement(null);
		for (ArrayList<ShadingProfile> group : groups)
			for (ShadingProfile profile : group)

...
public final class Line
{
	...
	{
		DummySource src = new DummySource("TestSource");
		Line line = new Line(src, 1, "this is a test line");
		line.print();

		line.tokenize();
		line.print();

		line.replace(3, "changed");
		line.print();

		line.set(1, "has", "become");
		line.print();

		line.set(line.numTokens() - 1, "test", "lne");
		line.print();
	}
	...
	{
		Line line = new Line(this.source, this.lineNum, String.join(" ", strings));
